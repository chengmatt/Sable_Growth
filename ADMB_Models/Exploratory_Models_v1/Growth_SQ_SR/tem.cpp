 ...
 *(ad_comm::global_datafile) >>  data_file;   //define .dat file from .ctl file (tem_2020_na_wh.dat...replace 2020 with current year)
  ...
  growth_model_switch.allocate("growth_model_switch");
 ...
 log_q8prior = log(q_srv8prior);
  ...
  wt_fish1_size_iter.allocate("wt_fish1_size_iter");
  wt_srv1_size_iter.allocate("wt_srv1_size_iter");
  wt_srv2_size_iter.allocate("wt_srv2_size_iter");
  wt_fish3_size_iter.allocate("wt_fish3_size_iter");
  wt_fish2_size_iter.allocate("wt_fish2_size_iter");
  wt_srv7_age_iter.allocate("wt_srv7_age_iter");
  wt_srv7_size_iter.allocate("wt_srv7_size_iter");
 ...
 spawn_fract = (spawn_fract - 1) / 12;
  ...
  wt_tv_m.allocate(styr,endyr,1,nages,"wt_tv_m");
  wt_tv_f.allocate(styr,endyr,1,nages,"wt_tv_f");
 ...
 cout<<"Number of trawl years:"<<nyrs_srv7<<endl;
  ...
  oac_fish1.allocate(1,nyrs_fish1_age,1,nages*2,"oac_fish1");
  ...
  oac_srv1.allocate(1,nyrs_srv1_age,1,nages*2,"oac_srv1");
  ...
  oac_srv2.allocate(1,nyrs_srv2_age,1,nages*2,"oac_srv2");
 cout<<"Number of ages srv2:"<<nyrs_srv2_age<<endl;
  ...
  osc_fish1.allocate(1,nyrs_fish1_size,1,nlenbins*2,"osc_fish1");
 ...
 cout<<"Number of fish 2 sizes:"<< nyrs_fish2_size <<endl;
  ...
  osc_fish3.allocate(1,nyrs_fish3_size,1,nlenbins*2,"osc_fish3");
 ...
 cout<<"Number of fish 4 sizes:"<< nyrs_fish4_size <<endl;
  ...
  osc_srv1.allocate(1,nyrs_srv1_size,1,nlenbins*2,"osc_srv1");
 cout<<"Number of srv1 size is:"<<nyrs_srv1_size<<endl;
  ...
  osc_srv2.allocate(1,nyrs_srv2_size,1,nlenbins*2,"osc_srv2");
  ...
  osc_srv7.allocate(1,nyrs_srv7_size,1,nlenbins*2,"osc_srv7");
 ...
 cout<<"Number of survey age years is "<<nyrs_srv7_age<<endl;
  ...
  sizeage_tv_m.allocate(styr,endyr,1,nages,1,nlenbins,"sizeage_tv_m");
  sizeage_tv_f.allocate(styr,endyr,1,nages,1,nlenbins,"sizeage_tv_f");
  eof.allocate("eof");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  logit_sexRatio.allocate(-10,10,2,"logit_sexRatio");
  ...
  log_a50_fish1_f.allocate(-5,5,ph_fish_sel_delt_alt,"log_a50_fish1_f");
  log_delta_fish1_f.allocate(-5,3,ph_fish_sel_delt_alt,"log_delta_fish1_f");
  ...
  log_a50_fish1_m.allocate(-5,5,ph_fish_sel_delt_alt,"log_a50_fish1_m");
  log_delta_fish1_m.allocate(-5,3,ph_fish_sel_delt_alt,"log_delta_fish1_m");
  ...
  log_a50_fish2.allocate(-1,5,ph_fish_sel_delt_alt,"log_a50_fish2");
  ...
  log_delta_srv2_f.allocate(-5,4,ph_srv2_sel,"log_delta_srv2_f");
  ...
  log_delta_srv2_m.allocate(-5,4,ph_srv2_sel,"log_delta_srv2_m");
  ...
  log_delta_srv10_f.allocate(-5,4,ph_LL_block2,"log_delta_srv10_f");
  ...
  log_delta_srv10_m.allocate(-5,4,ph_LL_block2,"log_delta_srv10_m");
  ...
  #endif
  eac_fish1.allocate(1,nyrs_fish1_age,1,nages*2,"eac_fish1");
  #ifndef NO_AD_INITIALIZE
    eac_fish1.initialize();
  #endif
  eac_srv1.allocate(1,nyrs_srv1_age,1,nages*2,"eac_srv1");
  #ifndef NO_AD_INITIALIZE
    eac_srv1.initialize();
  #endif
  eac_srv2.allocate(1,nyrs_srv2_age,1,nages*2,"eac_srv2");
  #ifndef NO_AD_INITIALIZE
    eac_srv2.initialize();
  #endif
  esc_fish1.allocate(1,nyrs_fish1_size,1,nlenbins*2,"esc_fish1");
  #ifndef NO_AD_INITIALIZE
    esc_fish1.initialize();
  #endif
  esc_fish2.allocate(1,nyrs_fish2_size,1,nlenbins,"esc_fish2");
  #ifndef NO_AD_INITIALIZE
    esc_fish2.initialize();
  #endif
  esc_fish3.allocate(1,nyrs_fish3_size,1,nlenbins*2,"esc_fish3");
  #ifndef NO_AD_INITIALIZE
    esc_fish3.initialize();
  #endif
  esc_fish4.allocate(1,nyrs_fish4_size,1,nlenbins,"esc_fish4");
  #ifndef NO_AD_INITIALIZE
    esc_fish4.initialize();
  #endif
  esc_srv1.allocate(1,nyrs_srv1_size,1,nlenbins*2,"esc_srv1");
  #ifndef NO_AD_INITIALIZE
    esc_srv1.initialize();
  #endif
  esc_srv2.allocate(1,nyrs_srv2_size,1,nlenbins*2,"esc_srv2");
  #ifndef NO_AD_INITIALIZE
    esc_srv2.initialize();
  #endif
  esc_srv7.allocate(1,nyrs_srv7_size,1,nlenbins*2,"esc_srv7");
  #ifndef NO_AD_INITIALIZE
    esc_srv7.initialize();
  #endif
  ...
  #endif
  sexRatio.allocate(1,2,"sexRatio");
  #ifndef NO_AD_INITIALIZE
    sexRatio.initialize();
  #endif
