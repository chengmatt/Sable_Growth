  ...
  for (i=1;i<=nyrs_srv1_age;i++)  // account for potential selectivity change in the DOM LL Survey
   {
    if(yrs_srv1_age(i)<yr_sel_chg_srv1)
     {   
      eac_srv1_f(i)  = ((1-prop_m(yrs_srv1_age(i)))*elem_prod(srv1_sel_f,natage_f(yrs_srv1_age(i))))* ageage;
      eac_srv1_m(i)  = ((prop_m(yrs_srv1_age(i)))*elem_prod(srv1_sel_m,natage_m(yrs_srv1_age(i))))* ageage;
    ...
    if(yrs_srv1_age(i)>=yr_sel_chg_srv1)
     {
      if(ph_LL_block2>0)  // if estimating new selectivity for recent time block then use srv10 selectivity
       {   
      eac_srv1_f(i)  = ((1-prop_m(yrs_srv1_age(i)))*elem_prod(srv10_sel_f,natage_f(yrs_srv1_age(i))))* ageage;
      eac_srv1_m(i)  = ((prop_m(yrs_srv1_age(i)))*elem_prod(srv10_sel_m,natage_m(yrs_srv1_age(i))))* ageage;
      eac_srv1_f(i) /=sum(eac_srv1_f(i));
      eac_srv1_m(i) /=sum(eac_srv1_m(i));
       } 
