...
dir_master<-here("Prop_Within_Growth_SQ_PartialLen")
...
pdf(paste0(dir_results,"//Composition_Fits.pdf"), width = 15, height = 10)
...
ggplot(n_at_age %>% filter(year %in% c(2011:2023)), aes(x = age, y = prop, fill = sex)) +
