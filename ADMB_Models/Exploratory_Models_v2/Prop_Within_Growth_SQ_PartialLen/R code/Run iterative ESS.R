...
path<-here("Prop_Within_Growth_SQ_PartialLen")
...
ESS_JPLLFS_init = c(rep(20, 2), 0, rep(20, 3), rep(c(20,0), 4), 20)
...
for (i in 1:ITERS){
  ...
  wt_LLFS_f<-1/var(w_denom[w_denom != 0])
  ...
  wt_LLFS_m<-1/var(w_denom[w_denom != 0])
  ...
  wt_LLSS_f<-1/var(w_denom[w_denom != 0])
  ...
  wt_LLSS_m<-1/var(w_denom[w_denom != 0])
  ...
  wt_LLJSS_f<-1/var(w_denom[w_denom != 0])
  ...
  wt_LLJSS_m<-1/var(w_denom[w_denom != 0])
