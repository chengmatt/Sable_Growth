...
// fishery unbiased ages
    write_s_imatrix(sfile, value(oac_fish1_f), yrs_fish1_age, "oac.fish1.f", 1,nyrs_fish1_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names 
   
    write_s_imatrix(sfile, value(eac_fish1_f), yrs_fish1_age, "eac.fish1.f", 1,nyrs_fish1_age,1 ,nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names	

    write_s_imatrix(sfile, value(oac_fish1_m), yrs_fish1_age, "oac.fish1.m", 1,nyrs_fish1_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names 
   
    write_s_imatrix(sfile, value(eac_fish1_m), yrs_fish1_age, "eac.fish1.m", 1,nyrs_fish1_age,1 ,nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names   
    
// survey ages
    write_s_imatrix(sfile, value(oac_srv1_f), yrs_srv1_age, "oac.srv1.f", 1,nyrs_srv1_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names

     write_s_imatrix(sfile, value(eac_srv1_f), yrs_srv1_age, "eac.srv1.f", 1,nyrs_srv1_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names

    write_s_imatrix(sfile, value(oac_srv2_f), yrs_srv2_age, "oac.srv2.f", 1,nyrs_srv2_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names

    write_s_imatrix(sfile, value(eac_srv2_f), yrs_srv2_age, "eac.srv2.f", 1,nyrs_srv2_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names
    
    write_s_imatrix(sfile, value(oac_srv1_m), yrs_srv1_age, "oac.srv1.m", 1,nyrs_srv1_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names

     write_s_imatrix(sfile, value(eac_srv1_m), yrs_srv1_age, "eac.srv1.m", 1,nyrs_srv1_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names

    write_s_imatrix(sfile, value(oac_srv2_m), yrs_srv2_age, "oac.srv2.m", 1,nyrs_srv2_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names

    write_s_imatrix(sfile, value(eac_srv2_m), yrs_srv2_age, "eac.srv2.m", 1,nyrs_srv2_age, 1, nages);
    write_s_rownames_vec(sfile, aa, 1, nages, "ma", 0);  // this writes COLUMN names
