 ...
 *(ad_comm::global_datafile) >>  data_file;   //define .dat file from .ctl file (tem_2020_na_wh.dat...replace 2020 with current year)
 ...
 log_q8prior = log(q_srv8prior);
  ...
  wt_fish1_age_female_iter.allocate("wt_fish1_age_female_iter");
  wt_fish1_age_male_iter.allocate("wt_fish1_age_male_iter");
  wt_srv1_age_female_iter.allocate("wt_srv1_age_female_iter");
  wt_srv1_age_male_iter.allocate("wt_srv1_age_male_iter");
  wt_srv2_age_female_iter.allocate("wt_srv2_age_female_iter");
  wt_srv2_age_male_iter.allocate("wt_srv2_age_male_iter");
 ...
 cout<<"Number of trawl years:"<<nyrs_srv7<<endl;
  ...
  oac_fish1_m.allocate(1,nyrs_fish1_age,1,nages,"oac_fish1_m");
  oac_fish1_f.allocate(1,nyrs_fish1_age,1,nages,"oac_fish1_f");
  ...
  oac_srv1_f.allocate(1,nyrs_srv1_age,1,nages,"oac_srv1_f");
  oac_srv1_m.allocate(1,nyrs_srv1_age,1,nages,"oac_srv1_m");
  ...
  oac_srv2_m.allocate(1,nyrs_srv2_age,1,nages,"oac_srv2_m");
  oac_srv2_f.allocate(1,nyrs_srv2_age,1,nages,"oac_srv2_f");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  log_delta_fish1_f.allocate(-5,5,ph_fish_sel_delt,"log_delta_fish1_f");
  ...
  log_delta_fish1_m.allocate(-5,4,ph_fish_sel,"log_delta_fish1_m");
  ...
  log_a50_fish2.allocate(-1,2.5,ph_fish_sel_delt_alt,"log_a50_fish2");
  ...
  log_delta_fish3_m.allocate(-5,5,ph_fish_sel_delt_alt,"log_delta_fish3_m");
  ...
  log_delta_srv1_f.allocate(-5,4,ph_srv1_sel,"log_delta_srv1_f");
  ...
  log_delta_srv1_m.allocate(-5,4,ph_srv1_sel,"log_delta_srv1_m");
  ...
  #endif
  eac_fish1_m.allocate(1,nyrs_fish1_age,1,nages,"eac_fish1_m");
  #ifndef NO_AD_INITIALIZE
    eac_fish1_m.initialize();
  #endif
  eac_fish1_f.allocate(1,nyrs_fish1_age,1,nages,"eac_fish1_f");
  #ifndef NO_AD_INITIALIZE
    eac_fish1_f.initialize();
  #endif
  eac_srv1_m.allocate(1,nyrs_srv1_age,1,nages,"eac_srv1_m");
  #ifndef NO_AD_INITIALIZE
    eac_srv1_m.initialize();
  #endif
  eac_srv1_f.allocate(1,nyrs_srv1_age,1,nages,"eac_srv1_f");
  #ifndef NO_AD_INITIALIZE
    eac_srv1_f.initialize();
  #endif
  eac_srv2_m.allocate(1,nyrs_srv2_age,1,nages,"eac_srv2_m");
  #ifndef NO_AD_INITIALIZE
    eac_srv2_m.initialize();
  #endif
  eac_srv2_f.allocate(1,nyrs_srv2_age,1,nages,"eac_srv2_f");
  #ifndef NO_AD_INITIALIZE
    eac_srv2_f.initialize();
  #endif
  ...
  eac_srv7.allocate(1,nyrs_srv7_age,1,nages,"eac_srv7");
    ...
    eac_srv7.initialize();
  #endif
  esra_fish1_f.allocate(1,nyrs_fish1_age,"esra_fish1_f");
  #ifndef NO_AD_INITIALIZE
    esra_fish1_f.initialize();
  #endif
  esra_srv1_f.allocate(1,nyrs_srv1_age,"esra_srv1_f");
  #ifndef NO_AD_INITIALIZE
    esra_srv1_f.initialize();
  #endif
  esra_srv2_f.allocate(1,nyrs_srv2_age,"esra_srv2_f");
  #ifndef NO_AD_INITIALIZE
    esra_srv2_f.initialize();
  #endif
  esrs_fish1_f.allocate(1,nyrs_fish1_size,"esrs_fish1_f");
  #ifndef NO_AD_INITIALIZE
    esrs_fish1_f.initialize();
  #endif
  esrs_fish2_f.allocate(1,nyrs_fish2_size,"esrs_fish2_f");
  #ifndef NO_AD_INITIALIZE
    esrs_fish2_f.initialize();
  #endif
  esrs_fish3_f.allocate(1,nyrs_fish3_size,"esrs_fish3_f");
  #ifndef NO_AD_INITIALIZE
    esrs_fish3_f.initialize();
  #endif
  esrs_srv1_f.allocate(1,nyrs_srv1_size,"esrs_srv1_f");
  #ifndef NO_AD_INITIALIZE
    esrs_srv1_f.initialize();
  #endif
  esrs_srv2_f.allocate(1,nyrs_srv2_size,"esrs_srv2_f");
  #ifndef NO_AD_INITIALIZE
    esrs_srv2_f.initialize();
  #endif
  esrs_srv7_f.allocate(1,nyrs_srv7_size,"esrs_srv7_f");
  #ifndef NO_AD_INITIALIZE
    esrs_srv7_f.initialize();
  #endif
  osra_fish1_f.allocate(1,nyrs_fish1_age,"osra_fish1_f");
  #ifndef NO_AD_INITIALIZE
    osra_fish1_f.initialize();
  #endif
  osra_srv1_f.allocate(1,nyrs_srv1_age,"osra_srv1_f");
  #ifndef NO_AD_INITIALIZE
    osra_srv1_f.initialize();
  #endif
  osra_srv2_f.allocate(1,nyrs_srv2_age,"osra_srv2_f");
  #ifndef NO_AD_INITIALIZE
    osra_srv2_f.initialize();
  #endif
  osrs_fish1_f.allocate(1,nyrs_fish1_size,"osrs_fish1_f");
  #ifndef NO_AD_INITIALIZE
    osrs_fish1_f.initialize();
  #endif
  osrs_fish2_f.allocate(1,nyrs_fish2_size,"osrs_fish2_f");
  #ifndef NO_AD_INITIALIZE
    osrs_fish2_f.initialize();
  #endif
  osrs_fish3_f.allocate(1,nyrs_fish3_size,"osrs_fish3_f");
  #ifndef NO_AD_INITIALIZE
    osrs_fish3_f.initialize();
  #endif
  osrs_srv1_f.allocate(1,nyrs_srv1_size,"osrs_srv1_f");
  #ifndef NO_AD_INITIALIZE
    osrs_srv1_f.initialize();
  #endif
  osrs_srv2_f.allocate(1,nyrs_srv2_size,"osrs_srv2_f");
  #ifndef NO_AD_INITIALIZE
    osrs_srv2_f.initialize();
  #endif
  osrs_srv7_f.allocate(1,nyrs_srv7_size,"osrs_srv7_f");
  #ifndef NO_AD_INITIALIZE
    osrs_srv7_f.initialize();
  #endif
  surv_like.allocate(1,8,"surv_like");
  #ifndef NO_AD_INITIALIZE
    surv_like.initialize();
  #endif
  age_like.allocate(1,19,"age_like");
  #ifndef NO_AD_INITIALIZE
    age_like.initialize();
  #endif
  sel_like.allocate(1,12,"sel_like");
    ...
    sel_like.initialize();
  #endif
  sexratio_like.allocate(1,9,"sexratio_like");
  #ifndef NO_AD_INITIALIZE
  ...
  FABC2.initialize();
  #endif
  b40rat.allocate(styr,endyr,"b40rat");
